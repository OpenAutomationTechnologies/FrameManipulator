...
function loadTestSources()
{
    ...
    GEN_FILE_STIM_TEST=$GEN_FILE_STIM$TEST_NR$GEN_FILE_END
    GEN_FILE_FM_TEST=$GEN_FILE_FM$TEST_NR$GEN_FILE_END
    GEN_FILE_TIME_TEST=$GEN_FILE_TIME$TEST_NR$GEN_FILE_END
