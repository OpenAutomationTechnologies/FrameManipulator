...
set p0TxClk         PHY_TXCLK[0]
set p0RxClk         PHY_RXCLK[0]
set p1TxClk         PHY_TXCLK[1]
set p1RxClk         PHY_RXCLK[1]
...
## input
set_input_delay -clock phy0_vrxclk -max $phy_in_max [get_ports {PHY_RXDV[0] PHY_RXD[3] PHY_RXD[2] PHY_RXD[1] PHY_RXD[0]}]
set_input_delay -clock phy0_vrxclk -min $phy_in_min [get_ports {PHY_RXDV[0] PHY_RXD[3] PHY_RXD[2] PHY_RXD[1] PHY_RXD[0]}]
## output
set_output_delay -clock phy0_vtxclk -max $phy_out_max [get_ports {PHY_TXEN[0] PHY_TXD[3] PHY_TXD[2] PHY_TXD[1] PHY_TXD[0]}]
set_output_delay -clock phy0_vtxclk -min $phy_out_min [get_ports {PHY_TXEN[0] PHY_TXD[3] PHY_TXD[2] PHY_TXD[1] PHY_TXD[0]}]
## cut path
set_false_path -from [get_registers *] -to [get_ports PHY_GXCLK[0]]
set_false_path -from [get_registers *] -to [get_ports PHY_RESET_n[0]]
set_false_path -from [get_registers *] -to [get_ports PHY_MDC[0]]
set_false_path -from [get_registers *] -to [get_ports PHY_MDIO[0]]
set_false_path -from [get_ports PHY_MDIO[0]] -to [get_registers *]
#set_false_path -from [get_ports PHY_LINK[0]] -to [get_registers *]
set_false_path -from [get_ports PHY_RXER[0]] -to [get_registers *]
...
## input
set_input_delay -clock phy1_vrxclk -max $phy_in_max [get_ports {PHY_RXDV[1] PHY_RXD[7] PHY_RXD[6] PHY_RXD[5] PHY_RXD[4]}]
set_input_delay -clock phy1_vrxclk -min $phy_in_min [get_ports {PHY_RXDV[1] PHY_RXD[7] PHY_RXD[6] PHY_RXD[5] PHY_RXD[4]}]
## output
set_output_delay -clock phy1_vtxclk -max $phy_out_max [get_ports {PHY_TXEN[1] PHY_TXD[7] PHY_TXD[6] PHY_TXD[5] PHY_TXD[4]}]
set_output_delay -clock phy1_vtxclk -min $phy_out_min [get_ports {PHY_TXEN[1] PHY_TXD[7] PHY_TXD[6] PHY_TXD[5] PHY_TXD[4]}]
## cut path
set_false_path -from [get_registers *] -to [get_ports PHY_GXCLK[1]]
set_false_path -from [get_registers *] -to [get_ports PHY_RESET_n[1]]
set_false_path -from [get_registers *] -to [get_ports PHY_MDC[1]]
set_false_path -from [get_registers *] -to [get_ports PHY_MDIO[1]]
set_false_path -from [get_ports PHY_MDIO[1]] -to [get_registers *]
#set_false_path -from [get_ports PHY_LINK[1]] -to [get_registers *]
set_false_path -from [get_ports PHY_RXER[1]] -to [get_registers *]
